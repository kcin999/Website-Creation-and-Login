...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($first_name_err) && empty($last_name_err) && empty($short_bio_err) && empty($fav_number_err) && empty($email_address_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_username, $param_password, $param_first_name, $param_last_name, $param_short_bio, $param_email_address, $param_fav_number);
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
			...
			<div class="form-group <?php echo (!empty($fav_number_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="number" name="fav_number" class="form-control" value="<?php echo $fav_number; ?>">
